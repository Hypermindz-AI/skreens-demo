...
export const LBAR_CONCEPTS: LBarAd[] = [
  // Example 1: UberEats style - Top-Right (Image)
  {
    ...
    assets: {
      type: "image",
      image_url: "/ads/examples/ubereats-lbar-topright.svg",
      headline: "GET ALMOST ANYTHING. DELIVERED.",
      cta: "ORDER NOW",
      logo_url: "/ads/examples/ubereats-lbar-topright.svg",
      background_color: "#FFFFFF",
      text_color: "#000000",
      accent_color: "#06C167",
      qr_code_url: "/ads/qr-ubereats.svg",
  ...
  // Example 2: Lavazza style - Left-Bottom (Video)
  {
    ...
    assets: {
      type: "video",
      video_url: "/ads/examples/lavazza-poster.svg",
      poster_url: "/ads/examples/lavazza-poster.svg",
      headline: "LAVAZZA TABLÌ",
      subheadline: "Entra nel mondo di Lavazza Tablì",
      cta: "Scan QR",
      logo_url: "/ads/lavazza-logo.svg",
      background_color: "#F5F0E8",
      text_color: "#4A3728",
      accent_color: "#8B4513",
      qr_code_url: "/ads/qr-lavazza.svg",
  ...
  // Example 4: Budweiser - Left-Bottom (Video)
  {
    ...
    assets: {
      type: "video",
      video_url: "/ads/budweiser-poster.svg",
      poster_url: "/ads/budweiser-poster.svg",
      headline: "THIS BUD'S FOR YOU!",
      subheadline: "Raise a cold one for that play",
      cta: "Find Near You",
      logo_url: "/ads/budweiser-logo.svg",
      background_color: "#C8102E",
      text_color: "#FFFFFF",
      accent_color: "#FFD700",
      qr_code_url: "/ads/qr-budweiser.svg",
  ...
  // Example 5: DraftKings - Top-Left (Image)
  {
    ...
    assets: {
      type: "image",
      image_url: "/ads/draftkings-lbar.svg",
      headline: "LIVE ODDS NOW!",
      subheadline: "Bet the next play",
      cta: "Get $200 Bonus",
      logo_url: "/ads/draftkings-logo.svg",
      background_color: "#0D0D0D",
      text_color: "#FFFFFF",
      accent_color: "#53D337",
      qr_code_url: "/ads/qr-draftkings.svg",
  ...
  // Example 7: Toyota Halftime - Top-Right (Video)
  {
    ...
    assets: {
      type: "video",
      video_url: "/ads/toyota-poster.svg",
      poster_url: "/ads/toyota-poster.svg",
      headline: "HALFTIME DEAL",
      subheadline: "0% APR on 2025 Tundra",
      cta: "Build Yours",
      logo_url: "/ads/toyota-logo.svg",
      background_color: "#1A1A1A",
      text_color: "#FFFFFF",
      accent_color: "#EB0A1E",
      qr_code_url: "/ads/qr-toyota.svg",
